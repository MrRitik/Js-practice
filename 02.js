...
// object.forentries
console.log(Object.fromEntries(arr)); // convert arr into object { a: '1', b: '2', c: '4' }
...
abc.d = "g";
console.log("prevnt Extensions ", abc); // { a: '1', b: '2', c: '4', e: 'g' }
console.log("");

// Object.isExtensible()
console.log(Object.isExtensible(abc)); // check wheather we can add in the object (false)
console.log("");

// Object.seal()
console.log(abc); // before seal { a: '1', b: '2', c: '4', e: 'g' }
Object.seal(abc); // can not add or delete in object but can change it
abc.f = "f";
abc.a = "a";
delete abc.a;
console.log(abc); // after seal { a: 'a', b: '2', c: '4', e: 'g' }
console.log("");
